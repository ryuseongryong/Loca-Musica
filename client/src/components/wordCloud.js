...
function WordCloud1({ controlLikeRequestHandler, hashtagsData }) {
  ...
  return (
    <div className="wordcloud-container">
      <WordCloud className="wordcloud" data={data} width={wordCloudWidth()} height={wordCloudHeight} fontSizeMapper={fontSizeMapper} font={"Montserrat"} onWordClick={onWordClick} onWordMouseOver={onWordMouseOver} onWordMouseOut={onWordMouseOut}/>
    </div>
  );
}
