...
function Signup() {
    ...
    const signupRequestHandler = (event) => {
        ...
        else if (valuesChecker(email, username, password) && password === passwordCheck) {
            axios
                .post(
                ...
                <form>
                    ...
                    <div>
                        <input
                            ...
                            onChange={inputHandler}
                            onKeyUp={() => errMessageHandler(usernameChecker(inputValue.username))}
                            onFocus={clearErrMessage}
                        />
                        {
                    ...
                    <div>
                        <input
                            ...
                            onChange={inputHandler}
                            onKeyUp={() => errMessageHandler(passwordChecker(inputValue.password))}
                            onFocus={clearErrMessage}
                        />
                        {
